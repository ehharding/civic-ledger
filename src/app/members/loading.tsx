 ...
 *
 * Mirrors the real page's shape — header copy, one control row, then the card grid — so the skeleton resolves into the
 * page without anything jumping. The placeholder blocks are `aria-hidden` and paired with a live status message, so
 * assistive technology hears "Loading Members…" once rather than being read a wall of empty boxes.
 *
