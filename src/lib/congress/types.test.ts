 ...
 *
 * - `congressGovBillUrl` implements "The Official-Record Link Is Derived, Not Passed Through" (docs/decisions.md). It
 *   must never emit a confidently-wrong deep link, which is why an unrecognized type falls back to the site's home page
 *   rather than guessing a path segment.
