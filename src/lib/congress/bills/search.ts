import { BILL_TYPE_CODES, type BillStage, billStages, type LegislativeBill } from "@/lib/congress/bills/model";
import {
  ANY_FACET,
  type FacetFilter,
  parseEnumParam,
 ...
 *
 * The counterpart to `MEMBER_DIRECTORY_PARAMS` in `members/filter.ts`, and here for the same reason: these names cross
