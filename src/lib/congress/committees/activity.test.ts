...
import { getCommitteeRecords } from "@/lib/congress/committees/activity";
import type { CommitteeBillReferral, CommitteeRecordsResult } from "@/lib/congress/committees/records";
