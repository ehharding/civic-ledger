 ...
 *
 * @see http.ts for the transport and caching policy these functions share.
 * @see mappers.ts for the upstream-to-internal translation they all run their results through.
 */
