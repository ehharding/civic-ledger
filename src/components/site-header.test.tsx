...
describe("SiteHeader", (): void => {
   ...
   * moved it onto a row of its own below 640px. A sixth arriving without anyone revisiting that decision is exactly
   * the kind of change that ships looking fine on a laptop, so this asserts the count rather than only the members.
   */
