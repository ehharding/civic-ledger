...
import { DEFAULT_MEMBER_DIRECTORY_QUERY, type MemberDirectoryQuery } from "@/lib/congress/members/filter";
 ...
 * a write-only mirror silently overwrites with whatever the reader last narrowed to.
 */
