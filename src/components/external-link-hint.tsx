 ...
 * conveys nothing a sighted reader can't already infer, and announcing "external link icon" would be noise). The
 * result was that a screen-reader user heard only the link text and got no warning before a new tab took focus —
 * WCAG 3.2.5, and a genuinely disorienting one when it happens mid-page.
 *
